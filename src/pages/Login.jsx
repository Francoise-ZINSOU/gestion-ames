      ...
      <div style={{ width: '100%', maxWidth: 400, background: '#fff', borderRadius: 16, overflow: 'hidden', boxShadow: '0 4px 24px rgba(0,0,0,.06)' }}>
        ...
        {mode === 'login' && (
          <form onSubmit={handleSubmit} style={{ padding: '20px 28px 24px' }}>
            ...
            <div style={{ textAlign: 'right', marginBottom: 12 }}>
              <button type="button" onClick={() => { setMode('forgot'); setError('') }} style={{ background: 'none', border: 'none', fontSize: 11, color: '#3060d0', cursor: 'pointer', padding: 0 }}>Mot de passe oublié ?</button>
            </div>
        ...
        {mode === 'forgot' && (
          <form onSubmit={handleForgot} style={{ padding: '20px 28px 24px' }}>
            <div style={{ fontSize: 12, color: '#5a6480', marginBottom: 14, lineHeight: 1.6 }}>
            ...
            <div style={{ textAlign: 'center', marginTop: 14 }}>
              <button type="button" onClick={() => { setMode('login'); setError('') }} style={{ background: 'none', border: 'none', fontSize: 11, color: '#5a6480', cursor: 'pointer', padding: 0 }}>← Retour à la connexion</button>
            </div>
          </form>
        )}
        ...
        {mode === 'sent' && (
          <div style={{ padding: '20px 28px 24px', textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 13, color: '#5a6480', marginBottom: 16, lineHeight: 1.6 }}>
