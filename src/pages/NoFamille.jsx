  ...
  return (
    <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'center', minHeight: '100dvh', background: '#FBF7F1', fontFamily: 'DM Sans, sans-serif', padding: '60px 16px' }}>
      <div style={{ width: '100%', maxWidth: 400, background: '#fff', borderRadius: 16, overflow: 'hidden', boxShadow: '0 4px 24px rgba(0,0,0,.06)', textAlign: 'center', padding: '32px 28px' }}>
        ...
        <button onClick={logout} style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'none', border: '1px solid #C0563A', borderRadius: 7, padding: '8px 16px', color: '#C0563A', fontSize: 13, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' }}>
