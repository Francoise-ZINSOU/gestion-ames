  ...
  return (
    <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'center', minHeight: '100dvh', background: '#EEF2F7', fontFamily: 'DM Sans, sans-serif', padding: '60px 16px' }}>
      <div style={{ width: '100%', maxWidth: 420, background: '#fff', borderRadius: 16, overflow: 'hidden', textAlign: 'center', padding: '40px 28px', boxShadow: '0 4px 24px rgba(0,0,0,.06)' }}>
        ...
        <div style={{ textAlign: 'left', padding: '14px 16px', background: '#185FA508', border: '1px solid #185FA533', borderRadius: 10, marginBottom: 20 }}>
          <div style={{ fontSize: 13, fontWeight: 600, color: '#185FA5', marginBottom: 8 }}>Comment obtenir l'accès ?</div>
        ...
        <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
          <button onClick={() => window.location.reload()} style={S.btn('#185FA5', false)}>Rafraîchir</button>
          <button onClick={logout} style={S.btn('#64748B', true)}>Se déconnecter</button>
        </div>
      </div>
    </div>
  )
