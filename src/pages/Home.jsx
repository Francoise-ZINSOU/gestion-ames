import { S, fmt, fmtS, dago, getStatutColor } from '../lib/ui'

export default function HomePage({ actifs, alertes, refs, openFiche }) {
  ...
  return (
    <div>
      ...
      {alertes.length > 0 && (
        <div style={{ padding: '8px 12px', borderRadius: 7, border: '1px solid #e0305033', background: '#e0305008', marginBottom: 14 }}>
